...
describe('row action collection rules', () => {
  it('exposes hard delete only for dependency-checked collections', () => {
    for (const collection of ['categories', 'brands', 'products', 'suppliers', 'customers', 'roles', 'documentSequences']) {
  ...
  it('exposes a status toggle only for ACTIVE/INACTIVE-style collections', () => {
    for (const collection of ['categories', 'brands', 'products', 'suppliers', 'customers', 'users', 'roles', 'documentSequences']) {
