...
/** Google Sheets automatic backup settings. */
export interface AppConfigBackup {
  enabled: boolean
  /** Backup interval in hours. */
  intervalHours: 1 | 3 | 6 | 12 | 24
  spreadsheetId: string
  /** Service-account JSON key, masked once saved. Never log the plaintext key. */
  serviceAccountJson: string
  /** True when both a spreadsheet ID and a key are stored. */
  configured: boolean
  lastRunAt: string
  lastStatus: string
  lastMessage: string
