...
export const stockModules: ModuleConfig[] = [
  ...
  createModule({
    ...
    title: 'Stock',
    singular: 'Product',
    description: 'Products with current stock, cost and pricing. Stock in, adjustment and damage run as actions from this page.',
    ...
    columns: [
      ...
      col('stockInQty', 'Total Stock In', { labelKm: 'ស្តុកចូលសរុប' }),
      col('stockOutQty', 'Stock Out', { labelKm: 'ស្តុកចេញ' }),
    ...
    fields: [
      ...
      // Spec §5.9 General tab: identity + the single editable sale price
      // (cost price / current stock hidden by request).
