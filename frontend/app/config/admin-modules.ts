...
export const adminModules: ModuleConfig[] = [
  createModule({
    ...
    actionPermissions: { create: 'user.manage', edit: 'user.manage', delete: 'user.manage' },
    collection: 'users',
  ...
  createModule({
    ...
    actionPermissions: { create: 'role.manage', edit: 'role.manage', delete: 'role.manage' },
    collection: 'roles',
    documentForm: 'roles',
    titleField: 'name',
    columns: [
  ...
  createModule({
    ...
    group: 'admin',
    permission: 'sequence.manage',
    actionPermissions: { create: 'sequence.manage', edit: 'sequence.manage', delete: 'sequence.manage' },
